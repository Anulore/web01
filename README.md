...
![Coordinate plane](https://github.com/CYEliN/web01/blob/master/img/web01_area_12025.png)

Координата Х задаётся через текстовое поле, а координаты Y и R - через кнопки
